...
const BulkActionsModal: React.FC<BulkActionsModalProps> = ({
  ...
  // Get explicit Tailwind classes for active tab
  // Dynamic classes like bg-${color}-50 won't be generated by Tailwind JIT
  const getActiveTabClasses = (color: string): string => {
    switch (color) {
      case 'purple':
        return 'bg-purple-50 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400 border-b-2 border-purple-600';
      case 'indigo':
        return 'bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-400 border-b-2 border-indigo-600';
      case 'red':
        return 'bg-red-50 dark:bg-red-900/30 text-red-700 dark:text-red-400 border-b-2 border-red-600';
      default:
        return 'bg-gray-50 dark:bg-gray-900/30 text-gray-700 dark:text-gray-400 border-b-2 border-gray-600';
    }
  };
