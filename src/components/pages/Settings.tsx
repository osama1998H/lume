    ...
    <div className="h-full overflow-y-auto">
      <div className="p-4 sm:p-6 lg:p-8">
        ...
        <nav
          ...
          role="tablist"
          aria-label={t('settings.tabsLabel', 'Settings sections')}
        >
          {tabs.map((tab) => {
            const Icon = tab.icon;
        ...
        <div className="pb-20">
          {/* General Tab */}
          {activeTab === 'general' && (
            <div id="general-tab-panel" role="tabpanel" aria-labelledby="general-tab" className="space-y-4 sm:space-y-6">
              <div className="card">
          ...
          {activeTab === 'tracking' && (
            <div id="tracking-tab-panel" role="tabpanel" aria-labelledby="tracking-tab" className="space-y-4 sm:space-y-6">
              <div className="card">
          ...
          {/* Data & Privacy Tab */}
          {activeTab === 'data' && (
            <div id="data-tab-panel" role="tabpanel" aria-labelledby="data-tab" className="space-y-4 sm:space-y-6">
              <div className="card">
          ...
          {/* About Tab */}
          {activeTab === 'about' && (
            <div id="about-tab-panel" role="tabpanel" aria-labelledby="about-tab" className="space-y-4 sm:space-y-6">
              <div className="card">
